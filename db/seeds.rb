...
Genre.create(name: 'Swing', description: 'seed genre description')
Genre.create(name: 'Country', description: 'seed genre description')
Genre.create(name: 'Pop', description: 'seed genre description')
Genre.create(name: 'Ballad', description: 'seed genre description')
Genre.create(name: 'Salsa', description: 'seed genre description')
